...
<template>
  ...
  <div class="flex gap-4">
    <button v-if="isActive" @click="pause" class="btn-primary w-[250px]">Pause</button>
    <button v-else @click="resume" class="btn-primary w-[250px]"><span v-if="counter === 0">Start</span><span v-else>Resume</span></button>
    <button  @click="counter = 0" class="btn-primary w-[250px]">Reset</button>
    ...
    <div class="flex flex-col gap-8 my-8">
      <div class="flex gap-4">
      <button @click="isActiveAnimation?pauseAnimation():resumeAnimation()" class="btn-primary w-[250px]">{{ isActiveAnimation?"Pause":"Resume"}}</button>
        <button @click="(speed>0)? speed--:''" class="btn-primary">+</button>
    ...
    <div class="flex flex-col mx-auto  content-start items-start gap-4 my-8">
      ...
      <button @click="hangBrowser" class="btn-primary">Hang Browser</button>
    </div>
  </component>
</template>
